...
import Syntax, { CodeBlock, CodeToken } from 'lextrix-modules/modules/syntax.js';
  ...
  const createLextrix = () => {
    ...
    const editor = new Lextrix(container, {
      ...
      registry: createRegistry([
        ...
        CodeToken,
        CodeBlock,
        Lextrix.import(lxrPath.format('code-block-container')),
      ]),
    });
    return editor;
  };
  ...
  describe('highlighting', () => {
    test('initialize', () => {
      ...
      expect(editor.root).toEqualHTML(
        `<div class="lxr-code-block-container" spellcheck="false">
          <div class="lxr-code-block" data-language="javascript">var test = 1;</div>
          <div class="lxr-code-block" data-language="javascript">var bugz = 0;</div>
        </div>
        <p><br></p>`,
      );
    ...
    test('adds token', async () => {
      ...
      expect(editor.root).toEqualHTML(
        `<div class="lxr-code-block-container" spellcheck="false">
            <div class="lxr-code-block" data-language="javascript"><span class="lxr-token hljs-keyword">var</span> test = <span class="lxr-token hljs-number">1</span>;</div>
            <div class="lxr-code-block" data-language="javascript"><span class="lxr-token hljs-keyword">var</span> bugz = <span class="lxr-token hljs-number">0</span>;</div>
          </div>
          <p><br></p>`,
      );
      expect(editor.getContents()).toEqual(
    ...
    test('change language', async () => {
      ...
      expect(editor.root).toEqualHTML(`
          <div class="lxr-code-block-container" spellcheck="false">
            <div class="lxr-code-block" data-language="ruby">var test = <span class="lxr-token hljs-number">1</span>;</div>
            <div class="lxr-code-block" data-language="ruby">var bugz = <span class="lxr-token hljs-number">0</span>;</div>
          </div>
          <p><br></p>`);
      expect(editor.getContents()).toEqual(
        new ChangeSet()
    ...
    test('invalid language', async () => {
      ...
      expect(editor.root).toEqualHTML(`
          <div class="lxr-code-block-container" spellcheck="false">
            <div class="lxr-code-block" data-language="plain">var test = 1;</div>
            <div class="lxr-code-block" data-language="plain">var bugz = 0;</div>
          </div>
          <p><br></p>`);
      expect(editor.getContents()).toEqual(
        new ChangeSet()
    ...
    test('split container', async () => {
      ...
      expect(editor.root).toEqualHTML(
        `
          <div class="lxr-code-block-container" spellcheck="false">
            <select class="lxr-ui" contenteditable="false">
    ...
    describe('allowedChildren', () => {
      ...
      test('modification', async () => {
        ...
        expect(editor.root).toEqualHTML(`
          <div class="lxr-code-block-container" spellcheck="false">
            <div class="lxr-code-block" data-language="javascript"><span class="lxr-token hljs-keyword">va</span><strong><span class="lxr-token hljs-keyword">r</span> t</strong>est = <span class="lxr-token hljs-number">1</span>;</div>
            <div class="lxr-code-block" data-language="javascript"><span class="lxr-token hljs-keyword">var</span> bugz = <span class="lxr-token hljs-number">0</span>;</div>
          </div>
          <p><br></p>`);
        expect(editor.getContents()).toEqual(
