import Selection, { Range } from 'lextrix-core/core/selection.js';
...
describe('Selection', () => {
  ...
  describe('format()', () => {
    test('trailing', () => {
      ...
      expect(selection.root).toEqualHTML(`
        <p>0123<strong><span class="lxr-cursor">${Cursor.CONTENTS}</span></strong></p>
      `);
    });
    ...
    test('split nodes', () => {
      ...
      expect(selection.root).toEqualHTML(`
      <p><em>01</em><strong><em><span class="lxr-cursor">${Cursor.CONTENTS}</span></em></strong><em>23</em></p>
      `);
    });
    ...
    test('between characters', () => {
      ...
      expect(selection.root).toEqualHTML(`
        <p><em>0<u><span class="lxr-cursor">${Cursor.CONTENTS}</span></u></em><strong>1</strong></p>
      `);
    });
    ...
    test('empty line', () => {
      ...
      expect(selection.root).toEqualHTML(`
        <p><strong><span class="lxr-cursor">${Cursor.CONTENTS}</span></strong></p>
      `);
    });
    ...
    test('multiple', () => {
      ...
      expect(selection.getRange()[0]?.index).toEqual(2);
      expect(selection.root).toEqualHTML(`
        <p>01<em style="color: red; background-color: blue;"><u><span class="lxr-cursor">${Cursor.CONTENTS}</span></u></em>23</p>
      `);
    });
    ...
    test('remove format', () => {
      ...
      expect(selection.getRange()[0]?.index).toEqual(2);
      expect(selection.root).toEqualHTML(`
        <p><strong>01<u><span class="lxr-cursor">${Cursor.CONTENTS}</span></u>23</strong></p>
      `);
    });
    ...
    test('no cleanup', () => {
      ...
      expect(selection.getRange()[0]?.index).toEqual(2);
      expect(selection.root).toEqualHTML(`
        <p>01<em><span class="lxr-cursor">${Cursor.CONTENTS}</span></em>23</p>
      `);
    });
    ...
    describe('unlink cursor', () => {
      test('one level', () => {
        ...
        selection.format('bold', false);
        expect(selection.root).toEqualHTML(`
          <p><strong><a href="https://example.com">link</a></strong><span class="lxr-cursor">${Cursor.CONTENTS}</span></p>
          <p><br /></p>
        `);
      });
      ...
      test('nested formats', () => {
        ...
        selection.format('italic', false);
        expect(selection.root).toEqualHTML(`
          <p><strong><em><a href="https://example.com">bold</a></em><span class="lxr-cursor">${Cursor.CONTENTS}</span></strong></p>
          <p><br /></p>
        `);
      });
      ...
      test('ignore link format', () => {
        ...
        expect(selection.root).toEqualHTML(`
          <p><strong>bold<span class="lxr-cursor">${Cursor.CONTENTS}</span></strong></p>
          <p><br /></p>
        `);
      });
    });
  ...
  describe('getBounds()', () => {
    const setup = () => {
      ...
      container.classList.add('lxr-editor');
      const style = document.body.appendChild(document.createElement('style'));
      style.innerText =
        '.lxr-editor p, .lxr-editor img { margin: 0; padding: 0; border: 0; }';
    ...
    test('large text', () => {
      const { reference, container } = setup();
      const selection = createSelection(
        '<p><span class="lxr-size-large">0000</span></p>',
        container,
      );
