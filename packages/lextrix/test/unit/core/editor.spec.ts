...
import Text from 'lextrix-core/blots/text.js';
...
import { FontClass } from 'lextrix-formats/formats/font.js';
import Header from 'lextrix-formats/formats/header.js';
import Italic from 'lextrix-formats/formats/italic.js';
import { AlignClass } from 'lextrix-formats/formats/align.js';
import Video from 'lextrix-formats/formats/video.js';
import Strike from 'lextrix-formats/formats/strike.js';
import Underline from 'lextrix-formats/formats/underline.js';
...
import Blockquote from 'lextrix-formats/formats/blockquote.js';
import IndentClass from 'lextrix-formats/formats/indent.js';
import { ColorClass } from 'lextrix-formats/formats/color.js';
...
describe('Editor', () => {
  ...
  describe('applyChangeSet', () => {
    ...
    test('insert text before block embed', () => {
      const editor = createEditor(
        '<p>0123</p><iframe src="#" class="lxr-video" frameborder="0" allowfullscreen="true"></iframe>',
      );
      editor.applyChangeSet(new ChangeSet().retain(5).insert('5678'));
      expect(editor.scroll.domNode).toEqualHTML(
        '<p>0123</p><p>5678</p><iframe src="#" class="lxr-video" frameborder="0" allowfullscreen="true"></iframe>',
      );
    });
    ...
    test('insert attributed text before block embed', () => {
      ...
      expect(editor.scroll.domNode).toEqualHTML(
        '<p>0123</p><p><strong>5678</strong></p><iframe src="#" class="lxr-video" frameborder="0" allowfullscreen="true"></iframe>',
      );
    });
    ...
    test('insert formatted lines before block embed', () => {
      ...
      expect(editor.scroll.domNode).toEqualHTML(
        '<p>0123</p><p>a</p><h1>b</h1><iframe src="#" class="lxr-video" frameborder="0" allowfullscreen="true"></iframe>',
      );
    });
    ...
    test('insert block embed with delete before block embed', () => {
      ...
      expect(editor.scroll.domNode).toEqualHTML(
        '<p>0123</p><iframe src="#changed" class="lxr-video" frameborder="0" allowfullscreen="true"></iframe>',
      );
    });

    test('deletes block embed and appends text', () => {
      const editor = createEditor(
        `<p><br></p><iframe class="lxr-video" frameborder="0" allowfullscreen="true" src="#"></iframe><p>b</p>`,
      );
    ...
    test('multiple delete block embed and append texts', () => {
      const editor = createEditor(
        `<p><br></p><iframe class="lxr-video" frameborder="0" allowfullscreen="true" src="#"></iframe><iframe class="lxr-video" frameborder="0" allowfullscreen="true" src="#"></iframe><p>b</p>`,
      );
      editor.applyChangeSet(
    ...
    test('multiple nonconsecutive delete block embed and append texts', () => {
      const editor = createEditor(
        `<p><br></p>
         <iframe class="lxr-video" frameborder="0" allowfullscreen="true" src="#"></iframe>
         <p>a</p>
         <iframe class="lxr-video" frameborder="0" allowfullscreen="true" src="#"></iframe>
         <p>bb</p>
         <iframe class="lxr-video" frameborder="0" allowfullscreen="true" src="#"></iframe>
    ...
    describe('block embed', () => {
      test('improper block embed insert', () => {
        ...
        expect(editor.scroll.domNode).toEqualHTML(
          '<p>01</p><iframe src="#" class="lxr-video" frameborder="0" allowfullscreen="true"></iframe><p>23</p>',
        );
      });
      ...
      describe('insert and delete', () => {
        test('prepend', () => {
          ...
          expect(editor.scroll.domNode).toEqualHTML(
            '<iframe src="#" class="lxr-video" frameborder="0" allowfullscreen="true"></iframe><p>23</p>',
          );
        });
        ...
        test('insert to the middle of text', () => {
          ...
          expect(editor.scroll.domNode).toEqualHTML(
            '<p>a</p><iframe class="lxr-video" frameborder="0" allowfullscreen="true" src="#"></iframe><p><br></p>',
          );
        });
        ...
        test('insert after \\n', () => {
          ...
          expect(editor.scroll.domNode).toEqualHTML(
            '<p>a</p><iframe class="lxr-video" frameborder="0" allowfullscreen="true" src="#"></iframe><p>a</p>',
          );
        });
        ...
        test('insert after an inline embed', () => {
          ...
          expect(editor.scroll.domNode).toEqualHTML(
            '<p><img src="/assets/favicon.png"></p><iframe class="lxr-video" frameborder="0" allowfullscreen="true" src="#"></iframe><p>bc</p>',
          );
        });

        test('insert after a block embed', () => {
          const editor = createEditor(
            `<iframe class="lxr-video" frameborder="0" allowfullscreen="true" src="#"></iframe><p>abc</p>`,
          );
          editor.applyChangeSet(
            new ChangeSet().retain(1).insert({ video: '#' }).delete(2),
          );
          expect(editor.scroll.domNode).toEqualHTML(
            '<iframe class="lxr-video" frameborder="0" allowfullscreen="true" src="#"></iframe><iframe class="lxr-video" frameborder="0" allowfullscreen="true" src="#"></iframe><p>c</p>',
          );
        });
      });
      ...
      test('append formatted block embed', () => {
        ...
        expect(editor.scroll.domNode).toEqualHTML(
          '<p>0123</p><iframe src="#" class="lxr-video lxr-align-right" frameborder="0" allowfullscreen="true"></iframe><p><br></p>',
        );
      });
    });
    ...
    test('code block', () => {
      const editor = createEditor(
        '<p>0</p><div class="lxr-code-block-container"><div class="lxr-code-block">1</div><div class="lxr-code-block">23</div></div><p><br></p>',
      );
  ...
  describe('insertContents', () => {
    const video =
      '<iframe src="#" class="lxr-video" frameborder="0" allowfullscreen="true"></iframe>';
  ...
  describe('getFormat()', () => {
    ...
    test('cursor with preformat', () => {
      ...
      const lextrix = Lextrix.find(editor.scroll.domNode.parentElement!) as Lextrix;
      lextrix.selection.setRange(new Range(2));
      lextrix.selection.format('underline', true);
      lextrix.selection.format('color', 'red');
      expect(editor.getFormat(2)).toEqual({
        bold: true,
        italic: true,
        header: 1,
    ...
    test('across leaves', () => {
      const editor = createEditor(
        `
        <h1>
          <strong class="lxr-size-small"><em>01</em></strong>
          <em class="lxr-size-large"><u>23</u></em>
          <em class="lxr-size-huge"><u>45</u></em>
        </h1>
      `,
      );
    ...
    test('across leaves repeated', () => {
      const editor = createEditor(
        ...
        <h1>
          ...
          <em class="lxr-size-large"><u>23</u></em>
          <em class="lxr-size-huge"><u>45</u></em>
          <em class="lxr-size-small"><u>45</u></em>
        </h1>
      `,
      );
      expect(editor.getFormat(1, 4)).toEqual({
    ...
    test('across lines repeated', () => {
      const editor = createEditor(
        `
        <h1 class="lxr-align-right"><em>01</em></h1>
        <h1 class="lxr-align-center"><em>34</em></h1>
        <h1 class="lxr-align-right"><em>36</em></h1>
        <h1 class="lxr-align-center"><em>33</em></h1>
      `,
      );
  ...
  describe('getHTML', () => {
    ...
    test('across lines', () => {
      const editor = createEditor(
        '<h1 class="lxr-align-center">Header</h1><p>Text</p><blockquote>Quote</blockquote>',
      );
      expect(editor.getHTML(1, 14)).toEqual(
        '<h1 class="lxr-align-center">eader</h1><p>Text</p><blockquote>Quo</blockquote>',
      );
    });
      ...
      const editor = createEditor(
        `
          <ol>
            <li data-list="ordered">One</li>
            <li data-list="ordered">Two</li>
            <li data-list="bullet" class="lxr-indent-1">Alpha</li>
            <li data-list="ordered" class="lxr-indent-2">I</li>
            <li data-list="ordered" class="lxr-indent-2">II</li>
      ...
      const editor = createEditor(
        `
          <ol>
            ...
            <li data-list="unchecked" class="lxr-indent-1">Alpha</li>
            <li data-list="checked" class="lxr-indent-2">I</li>
            <li data-list="checked" class="lxr-indent-2">II</li>
    ...
    test('partial list', () => {
      const editor = createEditor(
        ...
        <ol>
          ...
          <li data-list="ordered" class="lxr-indent-1">AAAA</li>
          <li data-list="ordered" class="lxr-indent-2">IIII</li>
          <li data-list="ordered" class="lxr-indent-1">BBBB</li>
