import Lextrix, { globalRegistry, registerBlots } from 'lextrix-core';
import { registerFormats } from 'lextrix-formats';
import { describe, expect, test, vitest, beforeAll } from 'vitest';
import createRegistryWithFormats from 'lextrix-core/core/utils/createRegistryWithFormats.js';
