...
import { BaseTooltip } from 'lextron-themes';
...
describe('BaseTooltip', () => {
  const setup = () => {
    ...
    const editor = new Lextron(container, { registry: createRegistry([Video]) });
  ...
  describe('save', () => {
    test('converts youtube video url to embedded', () => {
      ...
      expect(
        (container.querySelector('.lxt-video') as HTMLVideoElement).src,
