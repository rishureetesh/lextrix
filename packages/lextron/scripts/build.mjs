...
const publishPkg = {
  ...
  type: 'module',
  exports: {
    '.': { import: './lextron.js', default: './lextron.js' },
    './core': { import: './lextron.core.js', default: './lextron.core.js' },
    './lextron.css': './lextron.core.css',
    './snow.css': './lextron.snow.css',
    './bubble.css': './lextron.bubble.css',
    './slate.css': './lextron.slate.css',
    './dawn.css': './lextron.dawn.css',
  },
  files: [
    'lextron.js',
    'lextron.core.js',
